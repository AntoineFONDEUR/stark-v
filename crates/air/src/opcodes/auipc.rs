//! Add-upper-immediate-to-PC execution, witness generation, and AIR constraints.
...
stwo_macros::define_air_fns! {
    ...
    fn auipc(clock, pc, rd_addr, imm_felt) {
        let rd_value = split_m31(pc + imm_felt);
        consume program_access(
            pc,
            constant(crate::instructions::Opcode::Auipc as u32),
            rd_addr,
            imm_felt,
            0,
        );
