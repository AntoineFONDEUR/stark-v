//! Register-immediate shift execution with generated witnesses.
...
stwo_macros::define_air_fns! {
    ...
    fn shifts_imm(
        ...
        let opcode = opcode_sll_flag * constant(crate::instructions::Opcode::Slli as u32)
        ...
        consume program_access(pc, opcode, rd_addr, rs1_addr, shift_amount);
