//! Trusted universal control program for recursion V2.
//!
...
const CONTROL_COLUMN_IDS: [&str; CONTROL_COLUMN_COUNT] = [
    "recursion_v2_control_segment_mask",
    "recursion_v2_control_binary_mask",
    "recursion_v2_control_verifier_id",
    "recursion_v2_control_sequence",
    "recursion_v2_control_tag",
    "recursion_v2_control_arg_0",
    "recursion_v2_control_arg_1",
    "recursion_v2_control_arg_2",
    "recursion_v2_control_arg_3",
];
...
mod tests {
    ...
    use super::*;
    use crate::v2::kernel::{VerifierProgramSpec, VerifierStep};
