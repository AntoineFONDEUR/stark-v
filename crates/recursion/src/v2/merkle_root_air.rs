...
const PREPROCESSED_COLUMN_IDS: [&str; PREPROCESSED_COLUMN_COUNT] = [
    "recursion_v2_merkle_root_row_mask",
    "recursion_v2_merkle_root_segment_mask",
    "recursion_v2_merkle_root_binary_mask",
    "recursion_v2_merkle_root_verifier_id",
    "recursion_v2_merkle_root_input_kind",
    "recursion_v2_merkle_root_item",
    "recursion_v2_merkle_root_tree_id",
    "recursion_v2_merkle_root_path_count",
];
