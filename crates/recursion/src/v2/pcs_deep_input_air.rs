...
const PREPROCESSED_COLUMN_IDS: [&str; PREPROCESSED_COLUMN_COUNT] = [
    "recursion_v2_pcs_deep_input_row_mask",
    "recursion_v2_pcs_deep_input_segment_mask",
    "recursion_v2_pcs_deep_input_binary_mask",
    "recursion_v2_pcs_deep_input_sampled_value_mask",
    "recursion_v2_pcs_deep_input_queried_value_mask",
    "recursion_v2_pcs_deep_input_oods_seed_mask",
    "recursion_v2_pcs_deep_input_deep_randomness_mask",
    "recursion_v2_pcs_deep_input_query_bit_mask",
    "recursion_v2_pcs_deep_input_query_position_mask",
    "recursion_v2_pcs_deep_input_answer_mask",
    "recursion_v2_pcs_deep_input_selector_mask",
    "recursion_v2_pcs_deep_input_verifier_id",
    "recursion_v2_pcs_deep_input_circuit_id",
    "recursion_v2_pcs_deep_input_node_id",
    "recursion_v2_pcs_deep_input_use_count",
    "recursion_v2_pcs_deep_input_source_index_0",
    "recursion_v2_pcs_deep_input_source_index_1",
    "recursion_v2_pcs_deep_input_source_index_2",
];
