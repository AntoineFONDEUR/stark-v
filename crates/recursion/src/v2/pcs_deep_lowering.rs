...
//! can therefore change values but cannot replace the native quotient graph.
...
fn operation_tuple(operation: Op) -> Result<(u32, u32, u32), PcsDeepLoweringError> {
    ...
    match operation {
        ...
        Op::Input | Op::Const => Err(PcsDeepLoweringError::NonArithmeticOperation),
    }
}
...
mod tests {
    ...
    use crate::v2::pcs_deep_input_air::{
    ...
    use crate::v2::query_position_air::{QueryPositionKind, QueryPositionRelations};
    use crate::v2::trace_merkle_air::TraceMerkleRelations;
    use crate::v2::transcript_payload_air::{VerifierInputKind, VerifierInputRelations};
    use crate::v2::verifier_randomness_air::{VerifierRandomnessKind, VerifierRandomnessRelations};
