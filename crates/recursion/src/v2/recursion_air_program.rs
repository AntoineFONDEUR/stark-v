...
///
/// Every hand-written V2 component compiles to a formal expression program
...
mod tests {
    ...
    use crate::v2::air_relation_parameters::{RelationChallengeCircuit, bind_relation_parameters};
    use crate::v2::oods_circuit::oods_point_from_seed;
    use crate::v2::universal_relations::universal_relation_descriptors;
