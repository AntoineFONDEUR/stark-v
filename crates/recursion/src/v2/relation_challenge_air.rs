//! Scoped ownership for relation challenges drawn by V2 verifier transcripts.
//!
...
const PREPROCESSED_COLUMN_IDS: [&str; PREPROCESSED_COLUMN_COUNT] = [
    "recursion_v2_relation_challenge_row_mask",
    "recursion_v2_relation_challenge_segment_mask",
    "recursion_v2_relation_challenge_binary_mask",
    "recursion_v2_relation_challenge_public_logup_mask",
    "recursion_v2_relation_challenge_verifier_id",
    "recursion_v2_relation_challenge_sequence",
    "recursion_v2_relation_challenge_tag",
    "recursion_v2_relation_challenge_arg_0",
    "recursion_v2_relation_challenge_arg_1",
    "recursion_v2_relation_challenge_arg_2",
    "recursion_v2_relation_challenge_arg_3",
    "recursion_v2_relation_challenge_index",
];
