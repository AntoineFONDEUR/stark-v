//! Statement-word boundary for the recursion V2 verifier.
//!
...
const PREPROCESSED_COLUMN_IDS: [&str; PREPROCESSED_COLUMN_COUNT] = [
    "recursion_v2_statement_input_row_mask",
    "recursion_v2_statement_input_segment_mask",
    "recursion_v2_statement_input_binary_mask",
    "recursion_v2_statement_input_verifier_id",
    "recursion_v2_statement_input_scope",
