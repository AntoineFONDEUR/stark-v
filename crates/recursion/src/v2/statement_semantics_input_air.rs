...
const PREPROCESSED_COLUMN_IDS: [&str; PREPROCESSED_COLUMN_COUNT] = [
    "recursion_v2_statement_semantics_input_row_mask",
    "recursion_v2_statement_semantics_input_statement_mask",
    "recursion_v2_statement_semantics_input_selector_mask",
    "recursion_v2_statement_semantics_input_private_mask",
    "recursion_v2_statement_semantics_input_integer_mask",
    "recursion_v2_statement_semantics_input_segment_active",
    "recursion_v2_statement_semantics_input_binary_active",
    "recursion_v2_statement_semantics_input_empty_active",
    "recursion_v2_statement_semantics_input_circuit_id",
    "recursion_v2_statement_semantics_input_node_id",
    "recursion_v2_statement_semantics_input_use_count",
    "recursion_v2_statement_semantics_input_scope",
    "recursion_v2_statement_semantics_input_word_index",
];
