//! Digest-state AIR for the trusted recursion V2 transcript layout.
//!
...
const PREPROCESSED_COLUMN_IDS: [&str; PREPROCESSED_COLUMN_COUNT] = [
    "recursion_v2_transcript_state_row_mask",
    "recursion_v2_transcript_state_segment_mask",
    "recursion_v2_transcript_state_binary_mask",
    "recursion_v2_transcript_state_verifier_id",
    "recursion_v2_transcript_state_sequence",
    "recursion_v2_transcript_state_tag",
    "recursion_v2_transcript_state_arg_0",
    "recursion_v2_transcript_state_arg_1",
    "recursion_v2_transcript_state_arg_2",
    "recursion_v2_transcript_state_arg_3",
    "recursion_v2_transcript_state_hash_id",
    "recursion_v2_transcript_state_input_key",
    "recursion_v2_transcript_state_output_key",
    "recursion_v2_transcript_state_initial_mask",
    "recursion_v2_transcript_state_consume_mask",
    "recursion_v2_transcript_state_produce_multiplicity",
    "recursion_v2_transcript_state_draw_output_mask",
];
