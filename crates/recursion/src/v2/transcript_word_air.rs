//! Word-ownership AIR for the trusted recursion V2 transcript layout.
//!
...
const PREPROCESSED_COLUMN_IDS: [&str; PREPROCESSED_COLUMN_COUNT] = [
    "recursion_v2_transcript_word_row_mask",
    "recursion_v2_transcript_word_segment_mask",
    "recursion_v2_transcript_word_binary_mask",
    "recursion_v2_transcript_word_verifier_id",
    "recursion_v2_transcript_word_sequence",
    "recursion_v2_transcript_word_tag",
    "recursion_v2_transcript_word_arg_0",
    "recursion_v2_transcript_word_arg_1",
    "recursion_v2_transcript_word_arg_2",
    "recursion_v2_transcript_word_arg_3",
    "recursion_v2_transcript_word_hash_id",
    "recursion_v2_transcript_word_index",
    "recursion_v2_transcript_word_is_payload",
    "recursion_v2_transcript_word_payload_index",
    "recursion_v2_transcript_word_constant",
];
