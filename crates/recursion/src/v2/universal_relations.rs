//! Canonical relation registry for the recursion V2 universal AIR.
//!
...
//! and V2-local structs follow in component-dependency order.
...
pub const UNIVERSAL_RELATION_COUNT: usize = 50;
...
impl UniversalRelations {
    ...
    /// recursion and V2-local structs. Each struct draws its own fields in
...
const fn local_relation_descriptors() -> [RelationDescriptor; 38] {
    [
        RelationDescriptor {
        ...
        RelationDescriptor {
            name: "SpongeStepRelation",
            size: 18,
        },
        RelationDescriptor {
            name: "SpongeDataRelation",
            size: 10,
        },
        RelationDescriptor {
            name: "OpDefRelation",
...
mod tests {
    ...
    /// along unused, as do the two V1 channel-replay relations still sharing
    /// the recursion struct. The narrow `poseidon2` relation joins them: every
    ...
    #[test]
    fn registry_has_fifty_unique_relations() {
    ...
    fn registry_matches_drawn_relation_instances() {
        ...
        let instances = [
            ...
            instance_descriptor(&relations.recursion.sponge_step),
            instance_descriptor(&relations.recursion.sponge_data),
