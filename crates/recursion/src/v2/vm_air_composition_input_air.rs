...
const PREPROCESSED_COLUMN_IDS: [&str; PREPROCESSED_COLUMN_COUNT] = [
    "recursion_v2_vm_air_composition_input_row_mask",
    "recursion_v2_vm_air_composition_input_sampled_value_mask",
    "recursion_v2_vm_air_composition_input_claimed_sum_mask",
    "recursion_v2_vm_air_composition_input_challenge_mask",
    "recursion_v2_vm_air_composition_input_composition_randomness_mask",
    "recursion_v2_vm_air_composition_input_oods_point_mask",
    "recursion_v2_vm_air_composition_input_selector_mask",
    "recursion_v2_vm_air_composition_input_circuit_id",
    "recursion_v2_vm_air_composition_input_node_id",
    "recursion_v2_vm_air_composition_input_use_count",
    "recursion_v2_vm_air_composition_input_source_index_0",
    "recursion_v2_vm_air_composition_input_source_index_1",
];
...
mod tests {
    ...
    use super::*;
    use crate::v2::air_relation_parameters::RELATION_CHALLENGE_WORD_COUNT;
    use crate::v2::vm_air_composition_circuit::{
        VmAirCompositionWitness, build_vm_air_composition_circuit,
        build_vm_air_composition_reference,
    };
    use crate::v2::vm_air_program::VmAirProgram;
