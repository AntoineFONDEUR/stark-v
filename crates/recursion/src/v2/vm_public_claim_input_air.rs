...
const PREPROCESSED_COLUMN_IDS: [&str; PREPROCESSED_COLUMN_COUNT] = [
    "recursion_v2_vm_public_claim_input_row_mask",
    "recursion_v2_vm_public_claim_input_word_index",
    "recursion_v2_vm_public_claim_input_constant_mask",
    "recursion_v2_vm_public_claim_input_boolean_mask",
    "recursion_v2_vm_public_claim_input_u16_mask",
    "recursion_v2_vm_public_claim_input_constant",
    "recursion_v2_vm_public_claim_input_input_io_mask",
    "recursion_v2_vm_public_claim_input_input_io_index",
    "recursion_v2_vm_public_claim_input_output_io_mask",
    "recursion_v2_vm_public_claim_input_output_io_index",
];
