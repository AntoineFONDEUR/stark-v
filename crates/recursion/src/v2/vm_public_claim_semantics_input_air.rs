...
const PREPROCESSED_COLUMN_IDS: [&str; PREPROCESSED_COLUMN_COUNT] = [
    "recursion_v2_vm_claim_semantics_input_row_mask",
    "recursion_v2_vm_claim_semantics_input_claim_mask",
    "recursion_v2_vm_claim_semantics_input_statement_mask",
    "recursion_v2_vm_claim_semantics_input_selector_mask",
    "recursion_v2_vm_claim_semantics_input_private_mask",
    "recursion_v2_vm_claim_semantics_input_io_digest_mask",
    "recursion_v2_vm_claim_semantics_input_io_kind",
    "recursion_v2_vm_claim_semantics_input_circuit_id",
    "recursion_v2_vm_claim_semantics_input_node_id",
    "recursion_v2_vm_claim_semantics_input_use_count",
    "recursion_v2_vm_claim_semantics_input_word_index",
];
...
mod tests {
    ...
    use crate::v2::statement_semantics_circuit::StatementWords;
    use crate::v2::vm_public_claim::tests::shape;
    use crate::v2::vm_public_claim_semantics_circuit::tests::{valid_digests, valid_words};
    use crate::v2::vm_public_claim_semantics_circuit::{
