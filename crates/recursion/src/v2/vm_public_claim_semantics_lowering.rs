...
mod tests {
    ...
    use crate::v2::statement_input_air::{StatementInputRelations, VM_CLAIM_STATEMENT_SCOPE};
    use crate::v2::vm_public_claim::tests::shape;
    use crate::v2::vm_public_claim_input_air::{
        VM_CLAIM_SEMANTICS_SCOPE, VmPublicClaimInputRelations,
    };
    ...
    use crate::v2::vm_public_claim_semantics_input_air::{
    ...
    use crate::v2::vm_public_io_hash_air::VmPublicIoHashRelations;
