...
const PREPROCESSED_COLUMN_IDS: [&str; PREPROCESSED_COLUMN_COUNT] = [
    "recursion_v2_vm_public_logup_control_row_mask",
    "recursion_v2_vm_public_logup_control_sequence",
    "recursion_v2_vm_public_logup_control_tag",
    "recursion_v2_vm_public_logup_control_arg_0",
    "recursion_v2_vm_public_logup_control_arg_1",
    "recursion_v2_vm_public_logup_control_arg_2",
    "recursion_v2_vm_public_logup_control_arg_3",
];
